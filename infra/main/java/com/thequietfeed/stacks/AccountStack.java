...
import com.thequietfeed.constructs.AsyncApiLambda;
import com.thequietfeed.constructs.AsyncApiLambdaProps;
...
public class AccountStack extends Stack {
    ...
    @Value.Immutable
    public interface AccountStackProps extends StackProps, QuietFeedStackProps {
