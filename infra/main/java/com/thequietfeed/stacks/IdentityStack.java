...
public class IdentityStack extends Stack {
    ...
    @Value.Immutable
    public interface IdentityStackProps extends StackProps, QuietFeedStackProps {
    ...
    public IdentityStack(Construct scope, String id, StackProps stackProps, IdentityStackProps props) {
        ...
        // Values are provided via QuietFeedApplication after context/env resolution
        ...
        com.thequietfeed.utils.Route53AliasUpsert.upsertAliasToCloudFront(
                this,
